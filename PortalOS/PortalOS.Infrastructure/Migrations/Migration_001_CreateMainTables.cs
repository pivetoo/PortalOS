    ...
    public class Migration_001_CreateMainTables : Migration
    {
        public override void Up()
        {
            ...
            Create.Table("ordemservico")
                ...
                .WithColumn("horainicio").AsDateTime().NotNullable()
                .WithColumn("iniciointervalo").AsDateTime().Nullable()
                .WithColumn("fimintervalo").AsDateTime().Nullable()
                .WithColumn("horafim").AsDateTime().NotNullable()
